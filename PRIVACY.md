...
- **Capture content:** text you type, the invoking page's title, URL, and focused-frame selection captured when you open Quick Note. A context-menu selection overrides the focused-frame selection.
...
When you open Quick Note through its toolbar button, keyboard shortcut, or context menu, the extension reads the invoking page's title, URL, and focused-frame selection at that moment. A context-menu selection overrides the focused-frame selection. It does not track tab changes, automatically read page bodies, monitor background tabs or browsing history, run analytics, show ads, or sell data.
